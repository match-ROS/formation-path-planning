...
namespace bezier_splines
{
    ...
    {
        this->visu_helper_->visualizeMarkerArray(this->start_end_marker_array_id_);
        // this->visu_helper_->visualizeMarkerArray(this->control_point_marker_array_id_);
        this->visu_helper_->visualizeMarkerArray(this->tangent_marker_array_id_);
    }
    ...
    {
        this->start_end_marker_array_id_ = this->visu_helper_->addNewMarkerArray();
        ...
        this->start_end_marker_template_id_ = this->visu_helper_->addMarkerTemplate(marker_template_start_end);

        this->control_point_marker_array_id_ = this->visu_helper_->addNewMarkerArray();
        ...
        this->control_point_marker_template_id_ = this->visu_helper_->addMarkerTemplate(marker_template_control_point);

        this->tangent_marker_template_id_ = this->visu_helper_->addNewMarkerArray();
        ...
        this->tangent_marker_template_id_ = this->visu_helper_->addMarkerTemplate(marker_template_tangents);
    }

    void CubicBezierSplines::addStartEndPointToVisuHelper()
    {
        this->visu_helper_->addMarkerToExistingMarkerArray(this->start_end_marker_array_id_,
                                                           this->visu_helper_->createGeometryPose(this->start_pose_[0], this->start_pose_[1]),
                                                           this->start_end_marker_template_id_);
        this->visu_helper_->addMarkerToExistingMarkerArray(this->start_end_marker_array_id_,
    ...
    {
        this->visu_helper_->addMarkerToExistingMarkerArray(this->tangent_marker_array_id_,
                                                           this->visu_helper_->createGeometryPose(start_point[0], start_point[1]),
                                                           this->tangent_marker_template_id_);
        Eigen::Matrix<float, 2, 1> end_point;
        end_point = start_point + tangent;
        ROS_INFO("end_point: %f | %f", end_point[0], end_point[1]);
        this->visu_helper_->addMarkerToExistingMarkerArray(this->tangent_marker_array_id_,
